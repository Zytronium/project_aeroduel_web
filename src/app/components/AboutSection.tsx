...
export const AboutSection = () => {
  return (
    <section
      id="about"
      className="bg-[linear-gradient(-90deg,#7bf8ff,#ffffff,#7bf8ff)] text-foreground text-center"
    >
      ...
      <div className="relative w-full">
        ...
        <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center justify-center h-full px-4">
          <p className="text-navy font-bold text-lg text-center mb-6">
            ...
            aircraft to create an advanced aerial combat system for RC aircraft.
          </p>
          <p className="text-navy font-bold text-lg text-center mb-6">
            We're equipping high-performance RC fighter jets with camera systems
            that automatically detect targets equipped with Aeroduel detection
          ...
          <small className="text-navy font-bold text-center mb-6">
            * Please note that all pilots must be experienced and confident with
            their aircraft of choice. Pilots must follow all AMA safety
