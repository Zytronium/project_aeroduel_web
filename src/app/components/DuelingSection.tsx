      ...
      <div className="max-w-6xl mx-auto w-full">
        <div className="flex flex-col lg:flex-row items-center gap-8">
          ...
          <div className="flex-1 text-center lg:text-right w-full">
            <h1 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold mb-6 font-xirod tracking-wider text-gray-200 drop-shadow-[0_0_8px_rgba(239,68,68,0.6)] text-shadow-lg text-shadow-black px-6">
              Dueling
            </h1>
            <p className="text-sm sm:text-base md:text-lg text-red-200 leading-relaxed text-shadow-lg text-shadow-black pb-4 mb-4 px-4 sm:px-2 md:px-0">
            ...
            <p className="font-bold text-center lg:text-left w-full lg:max-w-[90%] xl:max-w-[80%] text-shadow-lg text-shadow-black text-red-200 text-sm sm:text-base md:text-lg px-4 sm:px-2 md:px-0">
              <a
                href="/how-it-works"
